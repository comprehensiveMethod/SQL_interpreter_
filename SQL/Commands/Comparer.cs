...
namespace SQL.Commands
{
    public static class Comparer
    {
        ...
        private static void SetCond()
        {
            ...
            cond["OR"] = (file, record, o1, o2) => { return bool.Parse(o1.ToString()) || bool.Parse(o2.ToString()); };
            cond["AND"] = (file, record, o1, o2) => { return bool.Parse(o1.ToString()) && bool.Parse(o2.ToString()); };
        }

        public static bool WhereCondition(Dbf file, DbfRecord record, string condition)
        {
            if (condition == "")
                return true;
